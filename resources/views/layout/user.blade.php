...
<head>
	...
	<!-- App favicon -->
	<link rel="shortcut icon" href="{{ asset('assets/images/favicon.ico') }}"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css"><!-- Daterangepicker css -->
    ...
    {{-- <li class="side-nav-item">
		                ...
		                <div class="collapse" id="sidebarPagesinvoice">
		                    <ul class="side-nav-second-level">
		                        <li class="side-nav-item">
		                            <a class="side-nav-link" href="">Personal</a>
		                        </li>
		                        <li class="side-nav-item">
		                            <a class="side-nav-link" href="">Corporate</a>
		                        </li>
		                    </ul>
		                </div>
		            </li>
